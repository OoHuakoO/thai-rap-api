...
export const STORE_DOCUMENT_MIME_REGEX =
  /^(image\/(jpeg|png|webp)|application\/(pdf|vnd\.openxmlformats-officedocument\.spreadsheetml\.sheet|vnd\.openxmlformats-officedocument\.wordprocessingml\.document)|text\/csv)$/;
